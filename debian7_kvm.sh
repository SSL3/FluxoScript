...
echo "                         Copyright FluxoScript.net                          "
echo "                        https://t.me/orangkuatsabahanterkini                         "
echo "               Created By Fluxo stev(fb.com/Fluxo)                 "
echo "--------------------------------------------------------------------------------"
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By Fluxo(fb.com/OrangKuatSabahan) ------------"
